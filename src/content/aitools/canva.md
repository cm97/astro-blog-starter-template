...
description: AI-powered design platform with text-to-image, background removal, and Magic Studio generative tools for everyone.
categories:
  - design
  - image-generation
use_cases:
...
self_hosted: false
features:
  - Magic Media for text-to-image and text-to-video generation
