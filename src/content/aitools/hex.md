...
description: AI-native data workspace combining SQL, Python, and natural language for collaborative analytics and visualization.
categories:
  - data-analysis
use_cases:
  - data-analysis
...
self_hosted: false
features:
  - Natural language to SQL and Python generation
  - Magic AI for automated chart creation and analysis
