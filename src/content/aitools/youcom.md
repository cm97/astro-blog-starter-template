...
description: AI-powered search engine with chat, code, and research modes offering cited answers and privacy controls.
categories:
  - search
  - chat
use_cases:
...
self_hosted: false
features:
  - AI chat grounded in real-time web search results
  - YouCode mode for coding questions with live execution
