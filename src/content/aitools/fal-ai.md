...
description: Serverless AI inference API for image, video, voice, and 3D generation with sub-second latency.
categories:
  - api-platform
  - image-generation
use_cases:
...
self_hosted: false
features:
  - 600+ production-ready generative models
  - Flux, Stable Diffusion, Recraft, and custom LoRAs
  - Sub-second cold starts and fast inference
