...
self_hosted: false
features:
  - Terminal-native agentic coding with multi-file editing
  - Deep git integration for commits, PRs, and conflict resolution
  - Autonomous task execution with tool use and shell access
