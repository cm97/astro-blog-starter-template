...
description: Platform for building and deploying voice AI agents with multilingual support and tool calling.
categories:
  - speech
  - agents
use_cases:
...
self_hosted: false
features:
  - Build voice AI agents via API and dashboard
  - 100+ languages support
  - Tool calling for external APIs and actions
